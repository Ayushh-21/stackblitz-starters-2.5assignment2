...
// sort by l2h or h2l pricing

const getSortedStocks = (pricing) => {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  let sortedStocks = stocks.sort(getSortedStocks(pricing));
  res.json({ stocks: sortedStocks });
});

// sort by l2h or h2l growth

const getSortedStocksByGrowth = (growth) => {
  return (stock1, stock2) => {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  let sortedStocks = stocks.sort(getSortedStocksByGrowth(growth));
  res.json({ stocks: sortedStocks });
});

// filter by exchange

let getFilterByExchange = (stock, exchange) => {
...
let getFilterByIndustry = (stock, industry) => {
